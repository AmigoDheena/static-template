...
$whatsapp = '
<a href="https://api.whatsapp.com/send?phone='. $phone[0] . '" target="_blank" style="position:fixed; bottom:90px; right:25px; text-align:center; font-size:30px; z-index:100;">
    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 48 48" style="margin-top:16px;">
